...
var addCloudL7 = function(image) {
  //var index = toaL7.toList(220).indexOf(t7toa.concat(image.get('LANDSAT_SCENE_ID')));
  var index = toaL7.toList(220).indexOf(ee.Image(ee.List(ee.String(t7toa).cat(ee.String(image.get('LANDSAT_SCENE_ID')))).getInfo()));
...
// Apply the join.
var innerJoinedL7 = innerJoin.apply(toaL7, srL7, filterTimeEq);
