...
// Add cloud band
var cloudTOAL7 = toaL7.map(cloudBandF);
  /*function(image) {
  return cloudBand(image);
});*/

var cloudTOAL5 = toaL5.map(cloudBandF);
  /*function(image) {
  return cloudBand(image);
});*/
...
// Apply cloud mask
var maskedColl7 = innerJoinedL7.map(cloudMaskF);
  /*function(image) {
  return cloudMask(ee.Image(image));
});*/
var maskedColl5 = innerJoinedL5.map(cloudMaskF);
  /*function(image) {
  return cloudMask(ee.Image(image));
});*/
